                    ...
                    <div className='row px-5'>
                        ...
                        <div className='col-lg-2 mb-2 mt-3'>
                            <div className="form-check">
                                <input className="form-check-input" type="radio"  name="attendance" id="flexRadioDefault1" onChange={(e) => presentUpdate(e)} />
                                <label className="form-check-label" for="flexRadioDefault1">Present</label>
                            </div>
                        </div>
                        <div className='col-lg-2 mb-2 mt-3'>
                            <div className="form-check">
                                <input className="form-check-input" type="radio" name="attendance" id="flexRadioDefault2" onChange={(e) => absenttUpdate(e)} />
                                <label className="form-check-label" for="flexRadioDefault2">Absent</label>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input"  type="checkbox" id="flexSwitchCheckDefault" onChange={(event) => updateAttendence(event, user._id, index, user.std_id)} />
